...
class StickersViewController: UIViewController, UIGestureRecognizerDelegate {
    ...
    override func viewDidLoad() {
        ...
        scrollView.contentSize = CGSize(width: screenSize.width,  height: scrollView.frame.size.height)
    ...
    func configureCollectionViews() {
        ...
        let emojisFrame = CGRect(x: 0, y: 0, width: UIScreen.main.bounds.width, height: view.frame.height - 40)
        ...
        emojisCollectioView.register(UINib(nibName: "EmojiCollectionViewCell", bundle: Bundle(for: EmojiCollectionViewCell.self)), forCellWithReuseIdentifier: "EmojiCollectionViewCell")
    }
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        UIView.animate(withDuration: 0.6) { [weak self] in
          ...
          self.view.frame = CGRect(x: 0, y: yComponent, width: frame.width, height: UIScreen.main.bounds.height - self.partialView)
        }
    }
